    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoveActors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoveActors_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoveActors_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovImages_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CinemaMovies_Halls_HallId",
                        column: x => x.HallId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoveActors_ActorId",
                table: "MoveActors",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_MoveActors_MovieId",
                table: "MoveActors",
                column: "MovieId");
